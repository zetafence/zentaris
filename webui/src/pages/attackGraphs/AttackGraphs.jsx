...
// AttackGraphs returns UX components with applications table
class AttackGraphs extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            behaviorApps: [],               // behavioral app items
    ...
    fetchApps(group) {
        var prom = FetchAppsData(group, true);
        prom.then((value) => {
...
export default withRouter(AttackGraphs);
